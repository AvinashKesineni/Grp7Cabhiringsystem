...
{ 
  ...
  $from=$_GET['frm'];
  $to=$_GET['to'];
  $sql="INSERT INTO `tblbooking` (`id`, `userEmail`, `VehicleId`, `From`, `To`, `Status`, `PostingDate`) VALUES ('', '$useremail', '$vhid', '$from', '$to', '$status', current_timestamp());";
if (mysqli_query($con,$sql )) {
 
  header('location:booking_info.php?vhid='.$vhid.'&frm='.$from.'&to='.$to.'');
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>₹<?php echo htmlentities($result->PricePerDay);?> </p>Per Mile
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              ...
              <li role="presentation" ><a href="#output " aria-controls="output"  role="tab" data-toggle="tab"  onclick="calcRoute();">Details </a></li>
              <li role="presentation"><a href="#googleMap" aria-controls="googleMap" role="tab" data-toggle="tab" onclick="calcRoute();">Map</a></li>
    ...
    <div class="form-group">
          ...
          <?php if($_SESSION['login'])
              ...
              <div class="form-group">
               ...
               <input type="submit" name="submit" value="Book Now" class="btn"></input>
              </div>
              <?php } else { ?>
