...
include('includes/login/connection.php');
...
if(isset($_GET["code"]))
{
  ...
  //DataBase Update Code starts here!!!
  
  $check_email = "SELECT * FROM tblusers WHERE EmailId = '$mail'";
  $code_res = mysqli_query($con, $check_email);
  ...
  else if(mysqli_num_rows($code_res) == 0)
  {
    $insert_data = "INSERT INTO `tblusers` (`id`, `FullName`, `fullnamer`, `licenceNumber`, `ContactNo`, `dob`, `EmailId`, `Password`, `code`, `status`, `RegDate`, `UpdationDate`,`Address`,`City`,`Country`) VALUES ('', '$username1', '$fullname', '', '', '', '$mail', '$password1', '$code', '$status', current_timestamp(), '','','','');";
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <a href="search-carresult.php" class="btn">Book Now <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
